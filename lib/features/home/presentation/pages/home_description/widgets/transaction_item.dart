...
class DescTransactionItem extends StatelessWidget {
  const DescTransactionItem({super.key, required this.transaction});
        ...
        children: [
          ...
          Text(
            ...
            style: context.textStyle.manrope16w500.copyWith(
              color: t.isIncome ? AppColor.success : context.colorScheme.error,
